...
/**
 * Servlet para gerenciamento do cadastro de Países.
 * 
 * @author David Buzatto
 */
@WebServlet( name = "PaisServlet", urlPatterns = { "/servlets/pais" } )
public class PaisServlet extends HttpServlet {
    ...
    protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        Dao<Pais> daoPais = DaoFactory.<Pais>getDao();
            ...
            switch ( acao ) {
                ...
                case "salvar":
                    ...
                    if ( id.equals( "null" ) ) {
                        ...
                        obj = daoPais.carregar( Pais.class, Long.parseLong( id ) );
                    }
